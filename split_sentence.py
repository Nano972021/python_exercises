...
2. The function takes 1 parameter called 'sentence', which represent the sentence to be split
3. The function returns the list of words in the sentence
---------------------------------------------------------------------
...
4. Loop over the sentence, as long as 'start' is less than the sentence's length:
    4.1.If sentence[start] is an empty space:
        4.1.1. If 'word' is empty - which means that no words have been added to the list:
            4.1.1.1. Increase the 'start' variable by 1
...
5. Add the value of 'word' to 'lst'
6. Return lst
---------------------------------------------------------------------
Test Data
1. "I have a car"
